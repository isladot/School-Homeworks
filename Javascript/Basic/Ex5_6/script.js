...
function ex5(){
    var d2 = new Date();
    document.getElementById("date").innerHTML = d2.getDate() + "-" + (d2.getMonth()+1) + "-" + d2.getFullYear();
    document.getElementById("hms").innerHTML = d2.getHours() + ":" + d2.getMinutes() + ":" + d2.getSeconds();
